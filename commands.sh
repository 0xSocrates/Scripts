...
echo -e '```'
echo -e "#"
echo -e "<h1 align="center"> Validator </h1>"
echo " "
...
echo -e '```'
echo -e "<h1 align="center"> Governance </h1>"
echo " "
...
echo -e '```'
echo -e "<h1 align="center"> Configuration Settings </h1>"
echo " "
echo -e " ## Pruning"
echo -e '```'
echo "sed -i \\"
...
echo -e '```'
echo -e "<h1 align="center"> Status And Control </h1>"
echo " "
echo -e "## Sync Status"
echo -e '```'
...
echo -e '```'
echo -e "<h1 align="center"> Service Management </h1>"
echo " "
